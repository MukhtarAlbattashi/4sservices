    ...
    <div class="container-fluid px-5">
        <div class="card">
            <div class="card-header">
                <h4>{{ __("public.categoriesEmployees") }} - {{$expenses->total()}}</h4>
            </div>
            <div class="card-body">
                <div class="row justify-content-between">
                    <div class="col-md-3">
                        @can(\App\Enums\AppPermissions::CAN_CREATE_EMPLOYEE_CATEGORIES)
                            <button class="btn btn-dark m-2" wire:click="add"
                            >
                                {{ __('public.add') }} {{ __("public.categoriesEmployees") }}
                            </button>
                        @endcan
                    </div>
                    <div class="col-md-3">
                        ...
                        <table class="table   table-bordered table-sm">
                            ...
                            @foreach($expenses as $expense)
                                <tr class="text-center table-font align-middle">
                                    ...
                                    <td>
                                        @can(\App\Enums\AppPermissions::CAN_EDIT_EMPLOYEE_CATEGORIES)
                                            <button
                                        ...
                                        @endcan
                                        @can(\App\Enums\AppPermissions::CAN_DELETE_EMPLOYEE_CATEGORIES)
                                            <button
