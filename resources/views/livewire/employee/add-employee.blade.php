    ...
    <div class="container-fluid px-5">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row  border-bottom p-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <option value="1">{{__('public.active')}}</option>
                            <option
                                value="0">{{__('public.notActive')}}</option>
                        </select>
                ...
                <div class="row  border-bottom p-3">
                    <div class="col-md-3">
                        ...
                        <input wire:model.defer="employee.employeeNumber" type="text" class="form-control text-center"
                               id="employeeNumber" required>
                        @error('employee.employeeNumber') <span
                            class="error text-danger fs-6">{{ $message }}</span> @enderror
                    </div>
                    <div class="col-md-3">
                        <label for="joinDate" class="form-label mt-2">{{ __("public.joinDate")}}</label>
                        <input wire:model.defer="employee.joinDate" type="date" class="form-control text-center"
                    ...
                    <div class="col-md-3">
                        ...
                        <input wire:model.defer="employee.employeeNameAr" type="text" class="form-control text-center"
                               id="employeeNameAr" required>
                        @error('employee.employeeNameAr') <span
                            class="error text-danger fs-6">{{ $message }}</span> @enderror
                    </div>
                    <div class="col-md-3">
                        <label for="employeeNameEn" class="form-label mt-2">{{ __("public.employeeNameEn")}}</label>
                        <input wire:model.defer="employee.employeeNameEn" type="text" class="form-control text-center"
                               id="employeeNameEn" required>
                        @error('employee.employeeNameEn') <span
                            class="error text-danger fs-6">{{ $message }}</span> @enderror
                    </div>
                    <div class="col-md-3">
                        <label for="email" class="form-label mt-2">{{ __("public.email")}}</label>
                        <input wire:model.defer="employee.email" type="text" class="form-control text-center" id="email"
                               required>
                    ...
                    <div class="col-md-3">
                        ...
                        <input wire:model.defer="employee.phone" type="text" class="form-control text-center" id="phone"
                               required>
                    ...
                    <div class="col-md-3">
                        ...
                        <input wire:model.defer="employee.password" type="password" class="form-control text-center"
                ...
                <div class="row  border-bottom p-3">
                    <div class="col-md-3">
                        ...
                        <input wire:model.defer="employee.jopNameAr" type="text" class="form-control text-center"
                               id="jopNameAr" required>
                        @error('employee.jopNameAr') <span
                            class="error text-danger fs-6">{{ $message }}</span> @enderror
                    </div>
                    <div class="col-md-3">
                        <label for="jopNameEn" class="form-label mt-2">{{ __("public.jopNameEn")}}</label>
                        <input wire:model.defer="employee.jopNameEn" type="text" class="form-control text-center"
                               id="jopNameEn" required>
                        @error('employee.jopNameEn') <span
                            class="error text-danger fs-6">{{ $message }}</span> @enderror
                    </div>
                    <div class="col-md-3">
                        <label for="birthDate" class="form-label mt-2">{{ __("public.birthDate")}}</label>
                        <input wire:model.defer="employee.birthDate" type="date" class="form-control text-center"
                               id="birthDate" required>
                        @error('employee.birthDate') <span
                            class="error text-danger fs-6">{{ $message }}</span> @enderror
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input wire:model.defer="employee.nationality" type="text" class="form-control text-center"
                               id="nationality" required>
                        @error('employee.nationality') <span
                            class="error text-danger fs-6">{{ $message }}</span> @enderror
                    </div>
                    <div class="col-md-3">
                        <label for="religion" class="form-label mt-2">{{ __("public.religion")}}</label>
                        <input wire:model.defer="employee.religion" type="text" class="form-control text-center"
                    ...
                    <div class="col-md-3">
                        ...
                        <input wire:model.defer="employee.socialStatus" type="text" class="form-control text-center"
                               id="socialStatus" required>
                        @error('employee.socialStatus') <span
                            class="error text-danger fs-6">{{ $message }}</span> @enderror
                    </div>
                </div>
                <div class="row  border-bottom p-3">
                    <div class="col-md-3">
                        ...
                        <input wire:model.defer="employee.idNumber" type="text" class="form-control text-center"
                    ...
                    <div class="col-md-3">
                        ...
                        <input wire:model.defer="employee.dateOfIssue" type="date" class="form-control text-center"
                               id="dateOfIssue" required>
                        @error('employee.dateOfIssue') <span
                            class="error text-danger fs-6">{{ $message }}</span> @enderror
                    </div>
                    <div class="col-md-3">
                        <label for="expiryDate" class="form-label mt-2">{{ __("public.expiryDate")}}</label>
                        <input wire:model.defer="employee.expiryDate" type="date" class="form-control text-center"
                               id="expiryDate" required>
                        @error('employee.expiryDate') <span
                            class="error text-danger fs-6">{{ $message }}</span> @enderror
                    </div>
                </div>
                <div class="row  border-bottom p-3">
                    <div class="col-md-3">
                        ...
                        <input wire:model.defer="employee.passportNumber" type="text" class="form-control text-center"
                               id="passportNumber" required>
                        @error('employee.passportNumber') <span
                            class="error text-danger fs-6">{{ $message }}</span> @enderror
                    </div>
                    <div class="col-md-3">
                        <label for="passportDateOfIssue"
                               class="form-label mt-2">{{ __("public.passportDateOfIssue")}}</label>
                        <input wire:model.defer="employee.passportDateOfIssue" type="date"
                               class="form-control text-center" id="passportDateOfIssue" required>
                        @error('employee.passportDateOfIssue') <span
                            class="error text-danger fs-6">{{ $message }}</span> @enderror
                    </div>
                    <div class="col-md-3">
                        <label for="passportExpiryDate"
                               class="form-label mt-2">{{ __("public.passportExpiryDate")}}</label>
                        <input wire:model.defer="employee.passportExpiryDate" type="date"
                               class="form-control text-center" id="passportExpiryDate" required>
                        @error('employee.passportExpiryDate') <span
                            class="error text-danger fs-6">{{ $message }}</span> @enderror
                    </div>
                    <div class="col-md-3">
                        <label for="placeOfIssue" class="form-label mt-2">{{ __("public.placeOfIssue")}}</label>
                        <input wire:model.defer="employee.placeOfIssue" type="text" class="form-control text-center"
                               id="placeOfIssue" required>
                        @error('employee.placeOfIssue') <span
                            class="error text-danger fs-6">{{ $message }}</span> @enderror
                    </div>
                </div>
                <div class="row  border-bottom p-3">
                    <div class="col-md-3">
                        ...
                        <input wire:model.defer="employee.academicQualification" type="text"
                               class="form-control text-center" id="academicQualification" required>
                        @error('employee.academicQualification') <span
                            class="error text-danger fs-6">{{ $message }}</span> @enderror
                    </div>
                    <div class="col-md-3">
                        <label for="typeAcademic" class="form-label mt-2">{{ __("public.typeAcademic")}}</label>
                        <input wire:model.defer="employee.typeAcademic" type="date" class="form-control text-center"
                               id="typeAcademic" required>
                        @error('employee.typeAcademic') <span
                            class="error text-danger fs-6">{{ $message }}</span> @enderror
                    </div>
                    <div class="col-md-3">
                        <label for="dateAcademic" class="form-label mt-2">{{ __("public.dateAcademic")}}</label>
                        <input wire:model.defer="employee.dateAcademic" type="date" class="form-control text-center"
                               id="dateAcademic" required>
                        @error('employee.dateAcademic') <span
                            class="error text-danger fs-6">{{ $message }}</span> @enderror
                    </div>
                    <div class="col-md-3">
                        <label for="placeAcademic" class="form-label mt-2">{{ __("public.placeAcademic")}}</label>
                        <input wire:model.defer="employee.placeAcademic" type="text" class="form-control text-center"
                               id="placeAcademic" required>
                        @error('employee.placeAcademic') <span
                            class="error text-danger fs-6">{{ $message }}</span> @enderror
                    </div>
                </div>
                <div class="row  border-bottom p-3">
                    <div class="col-md-3">
                        ...
                        <input wire:model.defer="employee.address" type="text" class="form-control text-center"
                               id="address" required>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea wire:model.defer="employee.notes" type="text" class="form-control text-center"
            ...
            <div class="card-footer d-flex justify-content-center">
                @can(\App\Enums\AppPermissions::CAN_CREATE_EMPLOYEES)
